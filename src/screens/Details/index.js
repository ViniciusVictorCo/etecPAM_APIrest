...
export default function Details(){
    ...
    const data = {titulo:route.params.titulo, nota:parseFloat(route.params.nota), imagem:route.params.imagem, descricao:route.params.descricao}
    ...
    return(
        <View style={style.container}>
            ...
            <Text style={style.title}>{data.descricao}</Text>
